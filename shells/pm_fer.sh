...
betas=(0.1 0.3 1 2)
for i in 0 1 2 3; do
CUDA_VISIBLE_DEVICES=$i python3 FER_CL.py --num_workers=32 --use_tf=True \
...
--loss=KBCL_ETF --etf_weight=${betas[$i]} --temperature=0.1 --utilize_target_centers=True --beta=1 --moco_k=256 --kcl_k=32 &
done; 
