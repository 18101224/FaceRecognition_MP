...
--model_type=kprpe12m \
--mean_weight=checkpoint/affectnet8_72K_oo \
--loss=KBCL_ETF --etf_weight=2 --kcl_k=5 --beta=0.3 --temperature=0.1 --balanced_cl=True  --utilize_target_centers=True --moco_k=72 