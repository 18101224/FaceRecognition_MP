...
# python3 analyze_classifier.py --dataset_name=CAER --dataset_path=../data/CAER-S --num_classes=7 \
# --aligner_path=checkpoint/adaface_vit_base_kprpe_webface12m \
# --save_path=results/caer_kbcl_etf_an --mode=analysis --model_type=ir50 --model_paths checkpoint/$caer_kbcl_etf \
# --model_names KBCL_ETF --ckpt_type=best

# python3 analyze_classifier.py --dataset_name=CAER --dataset_path=../data/CAER-S --num_classes=7 \
# --aligner_path=checkpoint/adaface_vit_base_kprpe_webface12m \
# --save_path=results/caer_kbcl_an --mode=analysis --model_type=ir50 --model_paths checkpoint/$caer_kbcl \
# --model_names KBCL --ckpt_type=best

# python3 analyze_classifier.py --dataset_name=CAER --dataset_path=../data/CAER-S --num_classes=7 \
# --aligner_path=checkpoint/adaface_vit_base_kprpe_webface12m \
# --save_path=results/caer_ce_an --mode=analysis --model_type=ir50 --model_paths checkpoint/$caer_ce \
# --model_names CE --ckpt_type=best
...
--aligner_path=checkpoint/adaface_vit_base_kprpe_webface12m \
--save_path=results/af7_compare_kbcl_vs_ce --mode=compare --model_type=kprpe12m --model_paths checkpoint/$af7_ce checkpoint/$af7_kbcl \
