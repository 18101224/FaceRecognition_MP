CUDA_VISIBLE_DEVICES=0,1 /pscratch/sd/s/sgkim/hcir/condaenvs/hcir/bin/torchrun --nproc_per_node=2 --rdzv-backend=c10d --rdzv-endpoint=localhost:29500 --nnodes=1 pretrain.py --world_size=2 \
